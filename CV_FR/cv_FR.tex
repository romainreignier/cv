...
Stage de fin d'études ingénieur.\\
Implémentation de ROS sur un robot hexapode et développement d'une nouvelle démarche pour le fanchissement de terrains irréguliers.
\SmallSep
