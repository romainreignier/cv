...
C, C++, Python, Matlab, Simulink, LabView, Java, OpenCV, Qt, Git\\ %Maple
\SkillItem{Embarqué}\\
Robot Operating System (ROS), GNU/Linux (Kernel driver, Yocto, Buildroot), Arduino, AVR, dsPIC, ARM Cortex M, mbed\\%, assembleur ST8\\
\SkillItem{CAO}\\
