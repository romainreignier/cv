...
C/C++, Pyhton, Matlab, LabView, Maple, OpenCV, microcontrollers: Arduino, AVR, PIC, ARM, Assembleur ST\\
...
% About me
\begin{AboutMe}
Looking for an engineering instership
\end{AboutMe}
...
Various jobs: Deauville International Polo Club, Electricite de France (EDF)\ldots
\Sep
